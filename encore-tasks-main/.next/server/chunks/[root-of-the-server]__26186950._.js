...
async function PUT(request, { params }) {
    try {
        ...
        const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2d$adapter$2d$optimized$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].getUserById(userId);
        if (!existingUser) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Пользователь не найден'
            }, {
        ...
        // Обновление пользователя
        const updatedUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2d$adapter$2d$optimized$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].updateUser(userId, updates);
        if (!updatedUser) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(request, { params }) {
    try {
        ...
        // Удаление пользователя
        const success = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2d$adapter$2d$optimized$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].deleteUser(userId);
        if (!success) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__26186950._.js.map