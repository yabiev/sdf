...
export async function GET(
  ...
  try {
    ...
    // TODO: Проверить доступ к проекту
    // const project = await db.getProjectById(task.projectId);
    // if (!project || (project.createdBy !== userId && !isProjectMember)) {
    //   return NextResponse.json(
    ...
    // TODO: Добавить проверку доступа к проекту через задачу
...
export async function PUT(
  ...
  try {
    ...
    // TODO: Проверить доступ к проекту
    // const project = await db.getProjectById(existingTask.projectId);
    // if (!project || (project.createdBy !== userId && !isProjectMember)) {
    //   return NextResponse.json(
    //     { error: 'Нет доступа к задаче' },
    //     { status: 403 }
