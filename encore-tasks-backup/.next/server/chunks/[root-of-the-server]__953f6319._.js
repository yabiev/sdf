...
async function GET(request) {
    try {
        ...
        if (role === 'admin') {
            ...
            projects = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2d$adapter$2d$optimized$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].getAllProjects();
        } else {
            // Обычные пользователи видят только свои проекты
            projects = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2d$adapter$2d$optimized$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].getProjectsByUserId(Number(userId));
        }
...
async function POST(request) {
    try {
        ...
        const project = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2d$adapter$2d$optimized$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].createProject(projectData);
        ...
        const board = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2d$adapter$2d$optimized$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].createBoard(`Доска проекта ${name}`, '', project.id);
        ...
        for (const column of defaultColumns){
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2d$adapter$2d$optimized$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].createColumn(column.name, board.id, column.position, column.color);
        }
        // Преобразование в формат API с правильной типизацией
        const projectResult = {
            id: project.id,
...
async function DELETE(request) {
    try {
        ...
        // Удаление проекта
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2d$adapter$2d$optimized$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].deleteProject(projectId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__953f6319._.js.map